...
class Musician {
  ...
  // статичне поле count, яке відслідковує кількість 
  //музикантів, початкове значення 0
   static count = 0;
  ...
  constructor(name, instrument) {
    ...
    // присвоєння вхідного значення name до приватного поля
    // #name
    this.#name = name;
    //=======
    // присвоєння вхідного значення instrument до приватного 
    // поля #instrument
...
class Concert extends Performance {
  ...
  // Створюємо setter для #ticketPrice, що дозволяє змінити приватну властивість #ticketPrice
     set ticketPrice(valueTicket) {
      this.#ticketPrice = valueTicket;
 ...
 * | members     | [bassist]       |
 */
// band.addMember(guitarist); //під питанням
